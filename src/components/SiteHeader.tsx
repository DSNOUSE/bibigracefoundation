...
import { Mail, Phone, Menu, X, Heart, Users, Mail as MailIcon, Share2, ChevronRight } from "lucide-react";
    ...
    <>
      ...
      <nav className={styles.nav}>
        <div className={styles.navInner}>
          ...
          >
            {mobileMenuOpen ? (
              <X size={36} strokeWidth={3} color="#5F236B" />
            ) : (
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="6" y1="10" x2="20" y2="10" stroke="#5F236B" strokeWidth="3" strokeLinecap="round"/>
                <line x1="6" y1="18" x2="20" y2="18" stroke="#5F236B" strokeWidth="3" strokeLinecap="round"/>
                <line x1="6" y1="26" x2="30" y2="26" stroke="#5F236B" strokeWidth="3" strokeLinecap="round"/>
              </svg>
            )}
          </button>
        </div>
      ...
      <div className={`${styles.mobileMenu} ${mobileMenuOpen ? styles.open : ""}`}>
        ...
        <div className={styles.mobileMenuContent}>
          ...
          <div className={styles.mobileImpactBanner}>
            <div>
              <span className={styles.mobileImpactNumber}>20+</span>
              <span className={styles.mobileImpactText}>Communities Reached</span>
            </div>
          </div>
